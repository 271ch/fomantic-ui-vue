...
<script>
export default {
  name: 'ModuleDropdownClearableSelection2',
  info: {
    converted: false,
    elementType: 'modules',
    element: 'dropdown',
    title1: 'Types',
    title2: 'Clearable Selection',
    description: 'A clearable selection dropdown can allow a user to cancel to cancel a previous selection',
    model: '      <div class="ui clearable multiple selection dropdown">\n' +
      '        <input type="hidden" name="language" value="dutch,english,french"/>\n' +
      '        <i class="dropdown icon"/>\n' +
      '        <div class="default text">Select Languages</div>\n' +
      '        <div class="menu">\n' +
