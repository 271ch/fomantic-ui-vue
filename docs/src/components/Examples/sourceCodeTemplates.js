...
s.ElementLabelAllVariantsofLabelcanbeinverted1 = 
  ...
  '    <a class="ui orange inverted label">Orange</a>\n' +
  '    <a class="ui yellow inverted label">Yellow</a>\n' +
  '    <a class="ui olive inverted label">Olive</a>\n' +
  '    <a class="ui green inverted label">Green</a>\n' +
  '    <a class="ui teal inverted label">Teal</a>\n' +
  '    <a class="ui blue inverted label">Blue</a>\n' +
  '    <a class="ui violet inverted label">Violet</a>\n' +
  '    <a class="ui purple inverted label">Purple</a>\n' +
  '    <a class="ui pink inverted label">Pink</a>\n' +
  '    <a class="ui brown inverted label">Brown</a>\n' +
  '    <a class="ui grey inverted label">Grey</a>\n' +
  '    <a class="ui black inverted label">Black</a>\n' +
  '    <p/>\n' +
  '    <a class="ui primary inverted basic label">Primary</a>\n' +
  '    <a class="ui secondary inverted basic label">Secondary</a>\n' +
  '    <a class="ui red inverted basic label">Red</a>\n' +
  '    <a class="ui orange inverted basic label">Orange</a>\n' +
  '    <a class="ui yellow inverted basic label">Yellow</a>\n' +
  '    <a class="ui olive inverted basic label">Olive</a>\n' +
  '    <a class="ui green inverted basic label">Green</a>\n' +
  '    <a class="ui teal inverted basic label">Teal</a>\n' +
  '    <a class="ui blue inverted basic label">Blue</a>\n' +
  '    <a class="ui violet inverted basic label">Violet</a>\n' +
  '    <a class="ui purple inverted basic label">Purple</a>\n' +
  '    <a class="ui pink inverted basic label">Pink</a>\n' +
  '    <a class="ui brown inverted basic label">Brown</a>\n' +
  '    <a class="ui grey inverted basic label">Grey</a>\n' +
  '    <a class="ui black inverted basic label">Black</a>\n' +
  '    <p/>\n' +
  '    <a class="ui inverted tag label">Tag</a>\n' +
  '    <a class="ui primary inverted tag label">Primary</a>\n' +
  '    <a class="ui secondary inverted tag label">Secondary</a>\n' +
  '    <a class="ui red inverted tag label">Red</a>\n' +
  '    <a class="ui orange inverted tag label">Orange</a>\n' +
  '    <a class="ui yellow inverted tag label">Yellow</a>\n' +
  '    <a class="ui olive inverted tag label">Olive</a>\n' +
  '    <a class="ui green inverted tag label">Green</a>\n' +
  '    <a class="ui teal inverted tag label">Teal</a>\n' +
  '    <a class="ui blue inverted tag label">Blue</a>\n' +
  '    <a class="ui violet inverted tag label">Violet</a>\n' +
  '    <a class="ui purple inverted tag label">Purple</a>\n' +
  '    <a class="ui pink inverted tag label">Pink</a>\n' +
...
s.ElementButtonLabeled1 = 
  ...
  '  </FuiButton>\n' +
  '  <FuiLabel tag=a basic>\n' +
  '    2,048\n' +
  '  </FuiLabel>\n' +
  '</FuiButton>\n' +
  '<FuiButton tag=div focusable labeled=left>\n' +
  '  <FuiLabel tag=a basic pointing=right>\n' +
  '    2,048\n' +
  '  </FuiLabel>\n' +
  '  <FuiButton tag=div>\n' +
  '    <FuiIcon name=heart></FuiIcon> Like\n' +
...
s.ElementButtonTertiary2 = 
  ...
  '<FuiButton color=orange tertiary>Orange</FuiButton>\n' +
  '<FuiButton color=yellow tertiary>Yellow</FuiButton>\n' +
  '<FuiButton color=olive tertiary>Olive</FuiButton>\n' +
  '<FuiButton color=green tertiary>Green</FuiButton>\n' +
  '<FuiButton color=teal tertiary>Teal</FuiButton>\n' +
  '<FuiButton color=blue tertiary>Blue</FuiButton>\n' +
  '<FuiButton color=violet tertiary>Violet</FuiButton>\n' +
  '<FuiButton color=purple tertiary>Purple</FuiButton>\n' +
...
s.ElementButtonColored1 = 
  ...
  '<FuiButton color=olive>Olive</FuiButton>\n' +
  '<FuiButton color=green>Green</FuiButton>\n' +
  '<FuiButton color=teal>Teal</FuiButton>\n' +
  '<FuiButton color=blue>Blue</FuiButton>\n' +
  '<FuiButton color=violet>Violet</FuiButton>\n' +
  '<FuiButton color=purple>Purple</FuiButton>\n' +
...
s.ElementButtonInverted2 = 
  ...
  '  <FuiButton inverted secondary basic>Secondary</FuiButton>\n' +
  '  <FuiButton inverted color=red basic>Basic Red</FuiButton>\n' +
  '  <FuiButton inverted color=orange basic>Basic Orange</FuiButton>\n' +
  '  <FuiButton inverted color=yellow basic>Basic Yellow</FuiButton>\n' +
  '  <FuiButton inverted color=olive basic>Basic Olive</FuiButton>\n' +
  '  <FuiButton inverted color=green basic>Basic Green</FuiButton>\n' +
  '  <FuiButton inverted color=teal basic>Basic Teal</FuiButton>\n' +
  '  <FuiButton inverted color=blue basic>Basic Blue</FuiButton>\n' +
  '  <FuiButton inverted color=violet basic>Basic Violet</FuiButton>\n' +
  '  <FuiButton inverted color=purple basic>Basic Purple</FuiButton>\n' +
  '  <FuiButton inverted color=pink basic>Basic Pink</FuiButton>\n' +
...
s.CollectionFormDisabledField1 = 
  ...
  '      <input placeholder="Read Only" type="text" disabled="disabled" tabindex="-1"/>\n' +
  '    </div>\n' +
  '    <div class="disabled field">\n' +
...
s.CollectionFormLoading1 = 
  ...
  '  <div class="ui submit button">Submit</div>\n' +
  '</div>\n' +
  '<div class="ui blue double loading form">\n' +
  '  <div class="field">\n' +
  '      <label>E-mail</label>\n' +
  '      <input type="email" placeholder="joe@schmoe.com"/>\n' +
  '  </div>\n' +
...
s.CollectionFormRadioCheckbox1 = 
  ...
  '    <div class="field">\n' +
  '      <div class="ui radio checkbox">\n' +
  '        <input type="radio" name="fruit2" checked="checked"/>\n' +
  '        <label>Apples</label>\n' +
  '      </div>\n' +
  '    </div>\n' +
  '    <div class="field">\n' +
...
s.CollectionTableTable2 = 
  ...
  '      </td>\n' +
  '      <td>\n' +
  '        <div class="ui yellow rating" data-rating="3" data-max-rating="3"/>\n' +
  '      </td>\n' +
...
s.ViewCardColumnCount1 = 
  ...
  '    <div class="extra">\n' +
  '      Rating:\n' +
  '      <div class="ui yellow rating" data-rating="2"/>\n' +
  '    </div>\n' +
  '  </div>\n' +
  '  <div class="card">\n' +
  '    <div class="image">\n' +
  ...
  '    <div class="extra">\n' +
  '      Rating:\n' +
  '      <div class="ui yellow rating" data-rating="3"/>\n' +
  '    </div>\n' +
  '  </div>\n' +
  '  <div class="card">\n' +
  '    <div class="image">\n' +
...
s.ViewCommentComments1 = 
  ...
  '  <p><b>UI Views</b> provide structured layouts, but do not hook up site specific code. You will need to add your own Javascript behaviors to hide and show the appropriate forms. For example, having a reply button open a reply form</p><p>\n' +
  '</p></div>\n' +
  '<div class="ui comments">\n' +
  '  <h3 class="ui dividing header">Comments</h3>\n' +
  '  <div class="comment">\n' +
